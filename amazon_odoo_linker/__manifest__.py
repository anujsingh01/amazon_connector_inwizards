# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            '/amazon_odoo_linker/static/src/components/amazon_dashboard.js',
            '/amazon_odoo_linker/static/src/components/amazon_dashboard.xml',
            # '/amazon_odoo_linker/static/src/components/custom.css',
            'amazon_odoo_linker/static/src/components/amazon_dashboard.js',
            'amazon_odoo_linker/static/src/components/amazon_dashboard.xml',           
        ],
    },
