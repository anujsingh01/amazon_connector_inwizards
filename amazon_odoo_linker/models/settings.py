...
class ResConfigSettings(models.TransientModel):
    ...
    client_key = fields.Char(string='Client Key', config_parameter='amazon_odoo_linker.client_key')
    client_secret_key = fields.Char(string='Client Secret Key', config_parameter='amazon_odoo_linker.client_secret_key')
    refresh_token = fields.Char(string='Refresh Token', config_parameter='amazon_odoo_linker.refresh_token')
