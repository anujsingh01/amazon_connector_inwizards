...
class AmazonStockAdjustmentReportHistory(models.Model):
    _name = "amazon.stock.adjustment.report.history"
    _inherit = ['mail.thread', 'mail.activity.mixin']
    
    # after finish
    # amz_stock_adjustment_report_ids = fields.One2many('stock.move', 'amz_stock_adjustment_report_id', string='Stock adjustment move ids')
