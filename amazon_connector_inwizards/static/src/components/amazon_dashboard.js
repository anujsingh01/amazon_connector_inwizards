...
OwlSalesDashboard.template = "amazon_connector_inwizards.sales_dashboard";
registry.category("actions").add("amazon_connector_inwizards.sales_dashboard", OwlSalesDashboard);
